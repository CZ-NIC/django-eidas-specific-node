...
from eidas_node.utils import (
    WrappedSeries,
    create_eidas_timestamp,
    datetime_iso_format_milliseconds,
    import_from_module,
...
class TestTimestampUtils(SimpleTestCase):
    ...
    def test_datetime_iso_format_milliseconds(self):
        self.assertEqual(
            datetime_iso_format_milliseconds(datetime(2017, 12, 11, 14, 12, 5, 148666)), "2017-12-11T14:12:05.148"
        )
        self.assertEqual(
            datetime_iso_format_milliseconds(datetime(2017, 12, 11, 14, 12, 5, 148000)), "2017-12-11T14:12:05.148"
        )
        self.assertEqual(
            datetime_iso_format_milliseconds(datetime(2017, 12, 11, 14, 12, 5, 0)), "2017-12-11T14:12:05.000"
        )
        self.assertEqual(
            datetime_iso_format_milliseconds(datetime(2017, 12, 11, 14, 12, 0, 0)), "2017-12-11T14:12:00.000"
        )
