...
class TestAuxiliaryIgniteStorage(IgniteMockMixin, SimpleTestCase):
    ...
    def test_get_cache_single_client_created(self):
        ...
        self.assertEqual(
            self.client_mock.mock_calls,
            [call.connect(self.HOST, self.PORT), call.get_cache("cache1"), call.get_cache("cache2")],
        )
...
class TestGetAuxiliaryStorage(IgniteMockMixin, SimpleTestCase):
    ...
    def test_ignite(self, storage_mock):
        ...
        self.assertSequenceEqual(
            ...
            [call(host="example.org", port=1234, cache_name="nodeSpecificProxyserviceRequestCache")],
        )

    def test_import_error(self):
        self.assertRaises(
            ImportError,
            get_auxiliary_storage,
